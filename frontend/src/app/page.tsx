...
export default function Homepage() {
  ...
  // Destacar item ativo conforme o scroll
  useEffect(() => {
    const handleScroll = () => {
  ...
  // Evitar rolagem de fundo quando o menu está aberto (mobile)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <nav className="fixed top-0 w-full bg-black/95 backdrop-blur-sm z-50 border-b border-gray-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {isMenuOpen && (
            <div
              id="mobile-menu"
              className="md:hidden absolute top-16 inset-x-0 bg-gray-900/95 border-t border-gray-800 shadow-xl z-50"
            >
      ...
      <section
        id="home"
        className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-black to-gray-900 scroll-mt-20"
      >
          ...
          <div
            ...
            style={{
              backgroundImage: `url("data:image/svg+xml,${encodeURIComponent(
                '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="grid" width="10" height="10" patternUnits="userSpaceOnUse"><path d="M 10 0 L 0 0 0 10" fill="none" stroke="#333333" stroke-width="0.5" opacity="0.3"/></pattern></defs><rect width="100" height="100" fill="url(#grid)"/></svg>'
              )}")`,
            }}
          />
        </div>
        ...
        <div className="text-center z-10 max-w-4xl px-4">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
            ...
            Mais de 5 anos construindo sistemas enterprise com DDD, CQRS e Clean
            Architecture.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-gray-300 text-lg mb-6 leading-relaxed">
                Sou um Senior .NET Engineer &amp; Backend Architect com sólida
                experiência em desenvolvimento de sistemas escaláveis e
                arquiteturas enterprise. Atualmente trabalhando na Gertec, lidero
                projetos de redesign de sistemas críticos utilizando Domain-Driven
                Design e CQRS.
              </p>
              <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                Minha especialização inclui desenvolvimento backend com .NET 8,
                integração com serviços AWS, e implementação de arquiteturas limpas
                que garantem escalabilidade e manutenibilidade. Tenho experiência
                comprovada em liderar equipes e mentorar desenvolvedores.
              </p>

              <div className="grid grid-cols-2 gap-6">
                {[
                  { number: "5+", label: "Anos de Experiência" },
                  { number: "20+", label: "Entregas em Produção" },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-gray-900 p-6 rounded-xl border border-gray-700 hover:border-cyan-400 transition-all duration-300 hover:transform hover:-translate-y-1"
              >
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
              {[
                ...
                <div
                  key={index}
                  className="bg-gray-800 p-6 rounded-xl border border-gray-700 hover:border-cyan-400 transition-all duration-300 hover:transform hover:-translate-y-1 text-center"
                >
                  ...
                  {item.href ? (
                    ...
                    <span className="text-cyan-400 font-medium block mb-2">
                      {item.text}
                    </span>
                  )}
